...
if [ "$dns" -eq 1 ]; then
    ...
    wget https://raw.githubusercontent.com/yeasin9090/AUTO-SCRIPT/master/ssh/cf
    dos2unix cf
    bash cf
elif [ "$dns" -eq 2 ]; then
...
# Install services
wget -q https://raw.githubusercontent.com/yeasin9090/AUTO-SCRIPT/master/ssh/ssh-vpn.sh
dos2unix ssh-vpn.sh
bash ssh-vpn.sh

wget -q https://raw.githubusercontent.com/yeasin9090/AUTO-SCRIPT/master/xray/ins-xray.sh
dos2unix ins-xray.sh
bash ins-xray.sh

wget -q https://raw.githubusercontent.com/yeasin9090/AUTO-SCRIPT/master/sshws/insshws.sh
dos2unix insshws.sh
bash insshws.sh
...
echo "=================================================================="
echo "Contact: https://t.me/Yeasin15"
echo "=================================================================="

# Additional commands
bash <(curl -Ls https://raw.githubusercontent.com/lalfulsk/Auto/main/dnsdisable.sh)
wget -O /root/log-install.txt https://github.com/yeasin9090/SCRIPTS/raw/main/log-install.txt
...
bash <(curl -Ls https://github.com/yeasin9090/SCRIPTS/raw/main/swap.sh)
